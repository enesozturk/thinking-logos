...
export const LOGO_PRESETS: Record<LogoMode, LogoPreset> = {
  ...
  connect: {
    ...
    opts: {
      ...
      yawRate: 0.5,
      tiltAmp: 0.08,
      // Dense on purpose. A sparse graph over a logo reads as a few stray
      // lines; the state only starts to look like circuitry once the nodes
      // are close enough together that the edges form a fabric.
      nodeCount: 58,
      reach: 1.35,
      wirePeriod: 3.6,
      wireSharp: 2.6,
